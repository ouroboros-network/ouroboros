...
impl DilithiumPublicKey {
 ...
 bail!("Invalid Dilithium public key length: {} (expected {})",
 bytes.len(), dilithium5::public_key_bytes());
 }
 Ok(Self { bytes })
 }
...
impl DilithiumSecretKey {
 ...
 bail!("Invalid Dilithium secret key length: {} (expected {})",
 bytes.len(), dilithium5::secret_key_bytes());
 }
 Ok(Self { bytes })
 }
...
impl DilithiumSignature {
 ...
 bail!("Invalid Dilithium signature length: {} (expected {})",
 bytes.len(), dilithium5::signature_bytes());
 }
 Ok(Self { bytes })
 }
...
impl KyberPublicKey {
 ...
 bail!("Invalid Kyber public key length: {} (expected {})",
 bytes.len(), kyber1024::public_key_bytes());
 }
 Ok(Self { bytes })
 }
...
impl KyberSecretKey {
 ...
 bail!("Invalid Kyber secret key length: {} (expected {})",
 bytes.len(), kyber1024::secret_key_bytes());
 }
 Ok(Self { bytes })
 }
...
impl KyberCiphertext {
 ...
 bail!("Invalid Kyber ciphertext length: {} (expected {})",
 bytes.len(), kyber1024::ciphertext_bytes());
 }
 Ok(Self { bytes })
 }
...
mod tests {
 ...
 println!(" Dilithium5 signature size: {} bytes", signature.bytes.len());
 }
 ...
 assert_eq!(shared_secret_alice.bytes.len(), kyber1024::shared_secret_bytes());
 println!(" Kyber1024 ciphertext size: {} bytes", ciphertext.bytes.len());
 println!(" Kyber1024 shared secret size: {} bytes", shared_secret_alice.bytes.len());
 }
 ...
 assert_eq!(keypair.public_key.bytes.len(), dilithium5::public_key_bytes());
 assert_eq!(keypair.secret_key.bytes.len(), dilithium5::secret_key_bytes());
 }
 ...
 assert_eq!(keypair.public_key.bytes.len(), kyber1024::public_key_bytes());
 assert_eq!(keypair.secret_key.bytes.len(), kyber1024::secret_key_bytes());
 }
}

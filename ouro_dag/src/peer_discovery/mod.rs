...
impl PeerDiscovery {
 ...
 log::debug!("WARNING Connection failure: {} (reputation: {})", address, peer.reputation);
 }
 }
...
mod tests {
 ...
 PeerInfo::new("192.168.1.1:9001".to_string(), vec![1], "node1".to_string(), 9091),
 PeerInfo::new("192.168.1.2:9001".to_string(), vec![2], "node2".to_string(), 9091),
 PeerInfo::new("192.168.1.3:9001".to_string(), vec![3], "node3".to_string(), 9091),
 ];

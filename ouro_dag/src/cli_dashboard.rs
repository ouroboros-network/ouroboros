...
pub fn print_dashboard(data: &DashboardData) {
    ...
    println!(
        "{} {}PEERS:{} {} connected     {}MEMPOOL:{} {} txs     {}TPS:{} {:.1}/s (1m) {:.1}/s (5m)",
        box_chars::VERTICAL,
        colors::BOLD,
        colors::RESET,
        data.peer_count,
    ...
    let disk_percent = (data.disk_used_gb / data.disk_total_gb) * 100.0;
    ...
    println!(
        "{} CPU: {}{:.1}%{}  MEM: {}{}MB{}  DISK: {}{:.1}/{:.1}GB{}  NET: ↓{:.0} ↑{:.0} KB/s",
        box_chars::VERTICAL,
        cpu_color,
        data.cpu_percent,
        colors::RESET,
    ...
    println!(
        "{}v{} | Press Ctrl+C to exit | ouro --help for commands{}",
        colors::DIM,
        data.version,
        colors::RESET
    );

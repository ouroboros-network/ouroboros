...
pub async fn start_bft_server(
 ...
 BftMessage::Vote(v) => hs_clone.handle_vote(v).await.map_err(|e| anyhow::anyhow!(e)),
 BftMessage::QC(qc) => hs_clone.handle_qc(qc).await.map_err(|e| anyhow::anyhow!(e)),
 _ => {

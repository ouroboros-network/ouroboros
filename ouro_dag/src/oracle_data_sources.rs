...
impl DataSourceCatalog {
    pub fn new() -> Self {
        ...
        // ============= CRYPTOCURRENCY =============
        sources.insert(DataCategory::Cryptocurrency, vec![
            DataSourceConfig {
        ...
        // ============= SPORTS =============
        sources.insert(DataCategory::Sports, vec![
            DataSourceConfig {
        ...
        // ============= WEATHER =============
        sources.insert(DataCategory::Weather, vec![
            DataSourceConfig {
        ...
        // ============= NEWS =============
        sources.insert(DataCategory::News, vec![
            DataSourceConfig {
        ...
        // ============= FINANCE/STOCKS =============
        sources.insert(DataCategory::Finance, vec![
            DataSourceConfig {
        ...
        // ============= WIKIPEDIA =============
        sources.insert(DataCategory::Wikipedia, vec![
            DataSourceConfig {
        ...
        // ============= GOVERNMENT DATA =============
        sources.insert(DataCategory::Government, vec![
            DataSourceConfig {
        ...
        // ============= SCIENCE =============
        sources.insert(DataCategory::Science, vec![
            DataSourceConfig {
        ...
        // ============= ENTERTAINMENT =============
        sources.insert(DataCategory::Entertainment, vec![
            DataSourceConfig {
        ...
        // ============= GAMING =============
        sources.insert(DataCategory::Gaming, vec![
            DataSourceConfig {
        ...
        // ============= SOCIAL MEDIA =============
        sources.insert(DataCategory::Social, vec![
            DataSourceConfig {
        ...
        // ============= HEALTH =============
        sources.insert(DataCategory::Health, vec![
            DataSourceConfig {
        ...
        // ============= TRANSPORTATION =============
        sources.insert(DataCategory::Transportation, vec![
            DataSourceConfig {
        ...
        // ============= FOOD/NUTRITION =============
        sources.insert(DataCategory::Food, vec![
            DataSourceConfig {
        ...
        // ============= RANDOM DATA =============
        sources.insert(DataCategory::RandomData, vec![
            DataSourceConfig {
        ...
        // ============= FUN (Jokes, Quotes, Facts) =============
        sources.insert(DataCategory::Fun, vec![
            DataSourceConfig {
        ...
        // ============= GEOGRAPHY =============
        sources.insert(DataCategory::Geography, vec![
            DataSourceConfig {
        ...
        // ============= LANGUAGE =============
        sources.insert(DataCategory::Language, vec![
            DataSourceConfig {
        ...
        // ============= BOOKS =============
        sources.insert(DataCategory::Books, vec![
            DataSourceConfig {
        ...
        // ============= ANIMALS =============
        sources.insert(DataCategory::Animals, vec![
            DataSourceConfig {
        ...
        // ============= INTERNET =============
        sources.insert(DataCategory::Internet, vec![
            DataSourceConfig {
        ...
        // ============= ART =============
        sources.insert(DataCategory::Art, vec![
            DataSourceConfig {
        ...
        // ============= MATH =============
        sources.insert(DataCategory::Math, vec![
            DataSourceConfig {
        ...
        // ============= EDUCATION =============
        sources.insert(DataCategory::Education, vec![
            DataSourceConfig {
        ...
        sources.insert(DataCategory::Blockchain, vec![
            DataSourceConfig {
